...
export function MenuDropdown() {
  ...
  const items: MenuItem[] = isAdmin
    ? [...ITEMS, { href: "/admin", label: "Admin", description: "Pool control & operations." }]
    : ITEMS;
  ...
  return (
    <div className="relative" ref={rootRef}>
      <motion.button
        ...
        whileTap={{ scale: 0.97 }}
        className="inline-flex items-center gap-2 px-5 py-3.5 rounded-full bg-zinc-100 text-ink text-utility hover:bg-white transition-colors"
      >
        {open ? (
